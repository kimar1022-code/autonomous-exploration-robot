...
└── (예정) ros2_ws/                   # base_controller 노드, URDF, launch
```
...
- [ ] **Phase 5**: PWM 속도 제어 추가
- [ ] **Phase 6**: base_controller ROS2 노드 (cmd_vel ↔ 시리얼)
- [ ] **Phase 7**: URDF + odometry
- [ ] **Phase 8**: RPLIDAR + SLAM 맵핑
- [ ] **Phase 9**: Nav2 자율주행
- [ ] **Phase 10**: 카메라 물체 탐지 + 촬영·전송
- [ ] **Phase 11**: Unity 관제 UI
